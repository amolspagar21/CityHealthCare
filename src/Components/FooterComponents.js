		...
		<div className="container footer">
			<div className="row">
				<div className="col-md-3 col-sm-6">
					...
					<h3>About</h3>
					<p>We aim to provide the details of medical services in the city on our website</p>
					<ul>
				...
				<div className="col-md-3 col-sm-6 b">
					...
					<ul>
						...
						<li><a href="/">Get the patient's request</a></li>
				...
				<div className="col-md-3 col-sm-6">
					...
					<ul>
						<li><a href="/"> 603, Race course road, Mumbai,
								India</a></li>
						<li><a href="/">+91 9623808003</a></li>
						<li><a href="/">chcp.response.info@gmail.com</a></li>
					</ul>
				</div>
			</div>
		</div>
